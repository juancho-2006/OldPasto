...
import main.java.model.GhostBlinky;
import main.java.model.GhostPinky;
import main.java.model.Map;
import main.java.model.ObjectGame;
import main.java.model.Pacman;
import main.java.model.Point;
import main.java.model.SuperPoint;
...
public class GameController implements Runnable {
    ...
    // ── Modelos ───────────────────────────────────────────────────────
    private final GamePannel vista;
    ...
    public GameController(GamePannel vista) {
        this.vista = vista;
        this.mapa = new Map();
        ...
        vista.assignModels(mapa, pacman, fantasmas);
